...
const main = async ()=>{
    try {
        ...
        const output = products.map((product)=>{
            ...
            if (typeof imgUrl === 'string' && imgUrl.startsWith('[')) try {
        ...
        $app.innerHTML = `<p class="Error">Ups! Algo sali\xf3 mal al cargar los productos.</p>`;
    }
};
main();

},{}]},["cRH9c","a0t4e"], "a0t4e", "parcelRequire5b12", {})
